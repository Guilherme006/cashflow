using Cash_Flow.Application.UseCases.Expenses.Reports.Pdf.Colors;
using Cash_Flow.Application.UseCases.Expenses.Reports.Pdf.Fonts;
using Cash_Flow.Domain.Reports;
...
using Cash_Flow.Domain.Extensions;
...
internal class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Author = "Guilherme Lazari";
    ...
    private void CreateHeader(Section page)
    {
        ...
        var pathFile = Path.Combine(directoryName!, "Logo", "crazycatgang_logo.png");

        row.Cells[0].AddImage(pathFile);

        row.Cells[1].AddParagraph("Crazy Cat Gang");
